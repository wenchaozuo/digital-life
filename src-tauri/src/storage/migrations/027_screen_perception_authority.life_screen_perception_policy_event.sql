CREATE TABLE life_screen_perception_policy_event (
    ...
    old_screen_perception_enabled INTEGER NOT NULL CHECK (old_screen_perception_enabled IN (0, 1)),
    new_screen_perception_enabled INTEGER NOT NULL CHECK (new_screen_perception_enabled IN (0, 1)),
    ...
    FOREIGN KEY (life_id) REFERENCES life_screen_perception_policy(life_id) ON DELETE CASCADE
);
