CREATE TABLE life_perception_policy_event (
    ...
    old_focus_context_enabled INTEGER NOT NULL CHECK (old_focus_context_enabled IN (0, 1)),
    new_focus_context_enabled INTEGER NOT NULL CHECK (new_focus_context_enabled IN (0, 1)),
    ...
    FOREIGN KEY (life_id) REFERENCES life_perception_policy(life_id) ON DELETE CASCADE
);
