CREATE TABLE model_profile_011 (
    id TEXT PRIMARY KEY CHECK (length(trim(id)) > 0),
    purpose TEXT NOT NULL CHECK (purpose IN ('chat', 'embedding', 'candidate_extraction')),
...
ALTER TABLE model_profile_011 RENAME TO model_profile;
